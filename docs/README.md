...
Here you can find all the information about the program that you may need.

**Table of contents:**
- \[[Installation](https://github.com/octoyeller/spinfetch/blob/main/docs/install.md)\] - how-to, requirements, files needed, removal
